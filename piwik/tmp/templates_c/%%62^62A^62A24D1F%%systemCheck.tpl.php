<?php /* Smarty version 2.6.26, created on 2010-07-02 12:17:46
         compiled from Installation/templates/systemCheck.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'translate', 'Installation/templates/systemCheck.tpl', 6, false),array('modifier', 'nl2br', 'Installation/templates/systemCheck.tpl', 32, false),array('function', 'url', 'Installation/templates/systemCheck.tpl', 254, false),)), $this); ?>
...
<?php else: ?><?php echo $this->_tpl_vars['warning']; ?>
 <br /><i><?php echo ((is_array($_tmp='Installation_SystemCheckMbstringHelp')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</i><?php endif; ?>
		</td>
	</tr>
	<?php endif; ?>
...
<?php echo $this->_tpl_vars['link']; ?>
 <a href="misc/redirectToUrl.php?url=http://piwik.org/docs/requirements/" target="_blank"><?php echo ((is_array($_tmp='Installation_Requirements')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</a> 
</p>
