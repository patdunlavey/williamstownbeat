...
<?php if (isset ( $this->_tpl_vars['onlyShowAddNewGoal'] )): ?>
    ...
    <p><?php echo ((is_array($_tmp='Goals_DescriptionGoalsManagement')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
 </p>
...
unset($_smarty_tpl_vars);
 ?>
	<?php if (! isset ( $this->_tpl_vars['onlyShowAddNewGoal'] )): ?>
		<div id='goalsCancel'><?php echo ((is_array($_tmp='General_OrCancel')) ? $this->_run_mod_handler('translate', true, $_tmp, "<a id='goalsCancelLink'>", "</a>") : smarty_modifier_translate($_tmp, "<a id='goalsCancelLink'>", "</a>")); ?>
</div>
	<?php endif; ?>
	<a id='bottom'></a>
</div>
