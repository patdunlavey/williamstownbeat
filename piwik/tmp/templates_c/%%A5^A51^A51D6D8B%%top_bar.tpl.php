...
<?php if ($this->_tpl_vars['userLogin'] != 'anonymous'): ?>| <a href='index.php?module=CoreAdminHome'><?php echo ((is_array($_tmp='General_Settings')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
</a><?php endif; ?> 
