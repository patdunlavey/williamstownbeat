...
" src="themes/default/images/table_more.png" />
			...
			<span class="tableGoals" style="display:none;float:right;padding-right:4px;">
				<?php if ($this->_tpl_vars['javascriptVariablesToSet']['viewDataTable'] != 'tableGoals'): ?>
					<img title="<?php echo ((is_array($_tmp='General_DisplayGoals')) ? $this->_run_mod_handler('translate', true, $_tmp) : smarty_modifier_translate($_tmp)); ?>
" src="themes/default/images/goal.png" />
				<?php endif; ?>
			</span>
			<?php endif; ?>
		</span>
